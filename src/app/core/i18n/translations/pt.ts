    ...
    items: [
      {
        ...
        highlights: [
          'Desenvolvi um sistema de gestão de pagamentos de serviços de água para Castle Water',
          'Frontend Angular baseado em componentes com foco em manutenibilidade e UX responsiva',
          'Desenvolvi APIs RESTful e stored procedures SQL para operações CRUD',
  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        title: 'JobLens',
        description:
          'Motor de pesquisa de empregos tech serverless na AWS. Uma pipeline ETL Lambda diária extrai ofertas de 4 APIs reais (Adzuna, TheMuse, Remotive, Arbeitnow), normaliza-as em S3 e indexa no OpenSearch. Frontend Angular 21 com Signals, autocompletar e filtros facetados. Mais de 993 ofertas reais.',
      },
    ],
  },
  contact: {
